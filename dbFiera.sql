...
id_payment_method bigInt NOT NULL REFERENCES payment_method(id_payment_method),	
...
id_item_state bigSerial PRIMARY KEY,
...
id_product_details bigInt NOT NULL REFERENCES product_details(id_product_details),
id_shopping_cart bigInt NOT NULL REFERENCES shopping_cart(id_shopping_cart),
