...
export class ShoppingCarModel {
    ...
    async createShoppingCarItem(id_product_details, quantity, id_shopping_cart, id_item_state) {
        const query = `INSERT INTO shopping_cart_item(id_product_details, id_shopping_cart,id_item_state,quantity) VALUES ($1,$2,$3,$4)`;
        const result = await pool.query(query, [id_product_details, id_shopping_cart, id_item_state,quantity]);
